...
const Page = () => {
  return (
    <div className="prose prose-sm prose-invert max-w-none">
      ...
      <ul>
        <li>
          This example has an artificial delay when &quot;fetching&quot; data for each category
          page. <code>loading.js</code> is used to show a loading skeleton immediately while data
          for category page loads before being streamed in.
        </li>
        <li>
          Shared layouts remain interactive while nested layouts or pages load. Try clicking the
